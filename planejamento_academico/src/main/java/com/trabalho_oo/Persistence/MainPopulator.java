...
//         // ALTERAÇÃO 1: O mapa de histórico agora é do tipo Map<String, Double>
//         Map<String, Double> historicoJoao = new HashMap<>();
//         // ALTERAÇÃO 2: A chave do mapa agora é a String do código da disciplina.
//         historicoJoao.put("DCC199", 85.0); // Aprovado em Algoritmo I
//         historicoJoao.put("MAT154", 70.0); // Aprovado em Cálculo I
...
//             }
//         }
//         // ALTERAÇÃO 3: O construtor do Aluno agora recebe o mapa corrigido.
...
//         // ALTERAÇÃO 1: O mapa de histórico agora é do tipo Map<String, Double>
//         Map<String, Double> historicoMaria = new HashMap<>();
//         // ALTERAÇÃO 2: A chave do mapa agora é a String do código da disciplina.
//         historicoMaria.put("DCC199", 95.0);
//         historicoMaria.put("DCC200", 90.0);
//         historicoMaria.put("DCC013", 88.0);
//         historicoMaria.put("DCC025", 92.0);
//         historicoMaria.put("DCC117", 75.0);
//         historicoMaria.put("DCC012", 80.0);
...
//                 // --- Turma B (criada para disciplinas selecionadas) ---
...
//     /**
//      * Método responsável por criar todas as disciplinas do curso.
